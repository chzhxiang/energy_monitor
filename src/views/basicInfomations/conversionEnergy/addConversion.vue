<template>
    <div>
        <el-form :model="ruleForm" :rules="rules" ref="ChangeTable" >
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-select label="能耗类型" prop="type"
                               placeholder="请选择用户角色"
                ...
                <el-col :span="11">
                    <yg-input label="类型编号" prop="username"
            ...
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-input label="能耗单位" prop="username"
                              :value="ruleForm.username"
                              formLabelWidth="100px"
                              @ygForm="getData"></yg-input>
                </el-col>
            ...
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-input label="标煤系数" prop="username"
                              :value="ruleForm.username"
                              formLabelWidth="100px"
                              @ygForm="getData"></yg-input>
                </el-col>
                <yg-blank :span="2"></yg-blank>
                <el-col :span="11">
                    <yg-input label="等效标煤单位" prop="username"
                              :value="ruleForm.username"
                              formLabelWidth="100px"
                              @ygForm="getData"></yg-input>
                </el-col>
            ...
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-select label="电值折算系数" prop="type"
                               placeholder="请选择用户角色"
                               formLabelWidth="100px"
                               :value="ruleForm.type"
                               :options="options.type"
                ...
                <yg-blank :span="2"></yg-blank>
                <el-col :span="11">
                    <yg-select label="等效电值单位" prop="type"
                               placeholder="请选择用户角色"
                               formLabelWidth="100px"
                               :value="ruleForm.type"
                               :options="options.type"
            ...
            <el-row :gutter="0">
                <div style="padding-left: 100px" class="remarkBox clear">
