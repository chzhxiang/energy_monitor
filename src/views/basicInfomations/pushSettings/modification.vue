    ...
    <div>
        <el-form :model="ruleForm" :rules="rules" ref="ChangeTable">
            <el-row :gutter="0">
                ...
                <el-col :span="11">
                    <yg-select label="推送角色" prop="type"
                               placeholder="请选择用户角色"
                               :value="ruleForm.type"
                               formLabelWidth="110px"
                               :options="options.type"
            ...
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-select label="推送类型" prop="type"
                               placeholder="请选择用户角色"
                               :value="ruleForm.type"
                               formLabelWidth="110px"
                               :options="options.type"
                ...
                <yg-blank :span="2"></yg-blank>
                <el-col :span="11">
                    <yg-select label="生成工单范围" prop="type"
                               placeholder="请选择用户角色"
                               :value="ruleForm.type"
                               formLabelWidth="110px"
                               :options="options.type"
            ...
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-select label="推送方式" prop="type"
                               placeholder="请选择用户角色"
                               :value="ruleForm.type"
                               formLabelWidth="110px"
                               :options="options.type"
                ...
                <yg-blank :span="2"></yg-blank>
                <el-col :span="11">
                    <yg-select label="推送内容" prop="type"
                               placeholder="请选择用户角色"
                               :value="ruleForm.type"
                               formLabelWidth="110px"
                               :options="options.type"
            ...
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-select label="推送周期" prop="type"
                               placeholder="请选择用户角色"
                               :value="ruleForm.type"
                               formLabelWidth="110px"
                               :options="options.type"
                ...
                <el-col :span="11">
                    <div class="typingInput mb20">
                        <span style="display:inline-block;width: 105px">起始时间</span>
                        <el-date-picker
                            style="width:206px"
            ...
            <el-row :gutter="0">
                <el-col :span="11">
                    <div class="typingInput mb20">
                        <span style="display:inline-block;width: 105px">推送时间</span>
                        <el-date-picker
                            style="width:206px"
                            v-model="ruleForm.startTime"
                            type="datetime"
