<template>
    <div class="BranchEnergyConsumptionBox">
        <h3 class="BranchEnergyConsumptiontit">支路能耗校核</h3>
        <div style="padding: 0 30px">
            ...
            <div class="BranchEnergyConsumptionData">校对结果 :&nbsp;&nbsp;异常: <span class="alarm">0 </span>&nbsp;&nbsp;&nbsp; 总共: <span class="all">3588</span></div>
        </div>
...
<style scoped>
    .BranchEnergyConsumptionBox{
        background: #fff;
    }
    .BranchEnergyConsumptiontit{
    ...
    .BranchEnergyConsumptionBox .BranchEnergyConsumptionData{
        position: relative;
        top: -8px;
    ...
    .BranchEnergyConsumptionBox .BranchEnergyConsumptionData span.alarm{
        color:#D94040 ;
    }
    .BranchEnergyConsumptionBox .BranchEnergyConsumptionData span.all{
        color:#188FBF ;
    }
