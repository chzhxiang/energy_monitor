<template>
    <div class="quotaPage">
        <QuotaSeting @posdata="setDta" :tableData="getSetdata"></QuotaSeting>
        <div class="chartsBox clear">
            <div class="fl charts">
                <div class="topButtom clear">
                    <div class="fl switchData">
                        <span :class="{act:defTypeData ==1? true:false}" @click="switchData(1)"><i class="iconfont nhjc-dianli"></i></span>
                        <span :class="{act:defTypeData ==2? true:false}" @click="switchData(2)"><i class="iconfont nhjc-shui"></i></span>
                        <span :class="{act:defTypeData ==3? true:false}" @click="switchData(3)"><i class="iconfont nhjc-qi"></i></span>
                    </div>
            ...
            <div class="fr right-box">
                <div class="tit"><b></b>累计能耗与定额比</div>
...
export default {
    ...
    methods: {
        ...
        getQuotaTabledata(usd, defd) { //渲染页面定额及用能图表
            ...
            this.option.yAxis[0].name = this.defTypeUnit[this.defTypeData];
            //this.defTypeUnit[this.defTypeData]
...
.right-box .tit{position: relative;height: 24px;font-size: 16px;color: #1881BF;font-weight: bold;}
.right-box .tit b{
    position: absolute;
    top:2px;
    left: -15px;
