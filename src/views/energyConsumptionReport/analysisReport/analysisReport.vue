<template>
    <div class="AnalysisReportBox">
        ...
        <div style="padding: 0 30px">
            <SearchBar :serBtName="serBtName" :inSearchData="setSearchtool" @outData="searBtclick" :btnList="searToolBtnList"></SearchBar>
        </div>
        ...
        <el-dialog class="popupWindow" title="模版管理" :visible.sync="isShowPopup.templateManagement" width="957px">
            <TemplateManagement @isHide="isShowPopup.templateManagement = false" @flushList="falush=new Date()"></TemplateManagement>
        </el-dialog>
    </div>
</template>
<script>
    ...
    export default {
            ...
            return{
                ...
                searToolBtnList: {
                    left: [
                        ...
                        {label: '模版管理', icon: '', className: 'bulueBg', action: 'TemplateManage'}
                    ]
                },
                tableData: {
                    tHead: [{
        ...
        methods:{
            searBtclick(oData){
                if(oData.action == "TemplateManage"){
                    this.isShowPopup.templateManagement=true;
                }
            },
            searchClick(outData) {
                console.log(outData);
