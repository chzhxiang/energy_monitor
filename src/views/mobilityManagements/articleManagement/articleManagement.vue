<template>
    <div class="containerBox">
        ...
        <el-dialog class="popupWindow" title="新增文章" :visible.sync="isShowPopup.addArticle" width="741px">
            <AddArticle @isHide="isShowPopup.addArticle = false" @flushList="falush=new Date()"></AddArticle>
       </el-dialog>
    </div>
</template>
<script>
    ...
    export default {
        name: 'table',
        components: {
            searchBar, dataTable,AddArticle
        },
        data() {
            return {
                isShowPopup: {
        ...
        methods: {
            ...
            searBtclick(oData) {
                if (oData.action == "add") {
                    this.isShowPopup.addArticle = true;
                }
            },
