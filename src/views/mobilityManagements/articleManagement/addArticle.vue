<template>
    <div>
        <el-form :model="ruleForm" :rules="rules" ref="insertAdmin">
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-radio-group label="文章属性" prop="editstatus"
                                    :value="ruleForm.editstatus"
                                    formLabelWidth="90px"
                                    :options="options.editstatus"
                                    @ygForm="getData"></yg-radio-group>
                </el-col>
                <yg-blank  :span="2"></yg-blank>
                <el-col :span="9">
                    <yg-input label="文章链接" prop="username"
                              :value="ruleForm.username"
                              formLabelWidth="90px"
                              @ygForm="getData"></yg-input>
                </el-col>
                <el-col :span="2">
                   <span class="articleReprint">转载</span>
                </el-col>
            </el-row>
            ...
            <el-row :gutter="0">
                <el-col :span="24">
                    <quill-editor v-model="ruleForm.editorContent" :options="editorOption"></quill-editor>
                </el-col>
            </el-row>
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-radio-group style="margin-top: 20px" label="状态" prop="devicestatus"
            ...
            <el-row :gutter="0">
                <el-col :span="11">
                    <div class="defbox"><label>创建用户</label>{{ruleForm.creater}}</div>
                </el-col>
                <yg-blank  :span="2"></yg-blank>
                <el-col :span="11">
                    <div class="defbox"><label>创建时间</label>{{ruleForm.creater_at}}</div>
                </el-col>
            </el-row>
        </el-form>
    ...
    export default {
        ...
        data() {
            return {
                ...
                labels: [
                    [
                        {label: '文章标题',labelWidth:"90px",  name: 'categoryname', yt: 'textarea', len: 24},
                    ],
                    [
                        {label: '文章副标',labelWidth:"90px",  name: 'categoryname', yt: 'textarea', len: 24},
                    ],
                    [
                        {label: '文章类别',labelWidth:"90px",  name: 'type', yt: 'select', len: 11},
                        {yt: 'empty', len: 2},
                        {label: '文章排序',labelWidth:"90px",  name: 'type', yt: 'select', len: 11},
                    ],
                    [
                        {label: '文章主图',labelWidth:"90px", name: 'avatar', yt: 'img', len: 11},
                        {yt: 'empty', len: 2},
                        {label: '首页推送位置',labelWidth:"90px",  name: 'type', yt: 'select', len: 11},
                    ],
                ],
                ruleForm: {
                    avatar: '',
