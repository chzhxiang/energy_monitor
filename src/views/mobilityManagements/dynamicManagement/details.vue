<template>
    <div>
        <el-form :model="ruleForm" :rules="rules" ref="insertAdmin">
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-radio-group label="动态类型" prop="Dynamicstatus"
                                    :value="ruleForm.Dynamicstatus"
                                    formLabelWidth="90px"
                                    :options="options.Dynamicstatus"
                                    @ygForm="getData"></yg-radio-group>
                </el-col>
                <yg-blank  :span="2"></yg-blank>
                <el-col :span="11">
                    <yg-radio-group label="状态" prop="showtatus"
                                    :value="ruleForm.showtatus"
                                    formLabelWidth="90px"
                                    :options="options.showtatus"
                                    @ygForm="getData"></yg-radio-group>
                </el-col>
            </el-row>
            <el-row :gutter="0">
            ...
            <el-row :gutter="0">
                <el-col :span="11">
                    <div class="defbox"><label>发布人</label>{{ruleForm.creater}}</div>
                </el-col>
                <yg-blank  :span="2"></yg-blank>
                <el-col :span="11">
                    <div class="defbox"><label>发布时间</label>{{ruleForm.creater_at}}</div>
                </el-col>
            </el-row>
        </el-form>
