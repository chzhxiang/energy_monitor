    ...
    export default {
        data() {
            return {
                ...
                labels: [
                    [
                        {label: '章节名称',labelWidth:"100px",  name: 'categoryname', yt: 'input', len: 11},
                        {yt: 'empty', len: 2},
                        {label: '章节主图',labelWidth:"100px", name: 'avatar', yt: 'img', len: 11},
                    ],
                    [
                        {label: '章节视频',labelWidth:"100px",  name: 'video', yt: 'file', len: 11},
                        {yt: 'empty', len: 2},
                        {label: '所属课程',labelWidth:"100px",  name: 'type', yt: 'select', len: 11},
                    ],
                    [
                        {label: '章节排序',labelWidth:"100px",  name: 'type', yt: 'select', len: 11},
                        {yt: 'empty', len: 2},
