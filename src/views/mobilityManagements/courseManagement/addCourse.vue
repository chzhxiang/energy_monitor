    ...
    export default {
        data() {
            return {
                ...
                labels: [
                    [
                        {label: '课程主图',labelWidth:"100px", name: 'avatar', yt: 'img', len: 11},
                        {yt: 'empty', len: 2},
                        {label: '课程视频',labelWidth:"100px",  name: 'video', yt: 'file', len: 11},
                    ],
                    [
                        {label: '课程类别',labelWidth:"100px",  name: 'type', yt: 'select', placeholder: '请选择类型', len: 11},
                        {yt: 'empty', len: 2},
                        {label: '展示位置',labelWidth:"100px",  name: 'type', yt: 'select', placeholder: '请选择类型', len: 11},
                    ],
                    [
                        {label: '课程名称',labelWidth:"100px",  name: 'categoryname', yt: 'input', len: 11},
                        {yt: 'empty', len: 2},
                        {label: '状态',labelWidth:"100px",  name: 'devicestatus', yt: 'radio', len: 11},
                    ],
                    [
                        {label: '课程简介',labelWidth:"100px", height:"68px", name: 'categoryname', yt: 'textarea', len: 24},
                    ],
                    [
