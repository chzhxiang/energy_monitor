<template>
    <div>
        <el-form :model="ruleForm" :rules="rules" ref="ChangeTable">
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-input label="参数名称" prop="username"
                ...
                <el-col :span="11">
                    <yg-input label="参数点表地址" prop="username"
                              :value="ruleForm.username"
            ...
            <el-row :gutter="0">
                ...
                <yg-blank :span="2"></yg-blank>
                <el-col :span="11">
                    <yg-select label="支路编号" prop="type"
                               placeholder="请选择用户角色"
                               :value="ruleForm.type"
                               formLabelWidth="100px"
                               :options="options.type"
            ...
            <el-row :gutter="0">
                ...
                <yg-blank :span="2"></yg-blank>
                <el-col :span="11">
                    <yg-select label="采集命令" prop="type"
                               placeholder="请选择用户角色"
                               :value="ruleForm.type"
                               formLabelWidth="100px"
                               :options="options.type"
            ...
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-input label="上限" prop="username"
                              :value="ruleForm.username"
                              formLabelWidth="80px"
                              @ygForm="getData"></yg-input>
                </el-col>
                <yg-blank :span="2"></yg-blank>
                <el-col :span="11">
                    <yg-input label="下限" prop="username"
                              :value="ruleForm.username"
                              formLabelWidth="100px"
                              @ygForm="getData"></yg-input>
                </el-col>
            ...
            <el-row :gutter="0">
                <el-col :span="11">
                    <div class="defbox"><label>修改人</label>李三</div>
                </el-col>
                <yg-blank :span="2"></yg-blank>
                <el-col :span="11">
                    <div class="defbox"><label>修改时间</label>2017</div>
                </el-col>
            </el-row>
            <el-row :gutter="0">
            </el-row>
