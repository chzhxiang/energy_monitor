<template>
    <div>
        <el-form :model="ruleForm" :rules="rules" ref="ChangeTable" >
            ...
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-select label="映射值类型" prop="type"
                               placeholder="请选择用户角色"
                               formLabelWidth="80px"
                               :value="ruleForm.type"
                               :options="options.type"
                ...
                <el-col :span="11">
                    <yg-select label="点表地址" prop="type"
                               placeholder="请选择用户角色"
                               formLabelWidth="80px"
                               :value="ruleForm.type"
                               :options="options.type"
            ...
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-input label="点表返回值" prop="username"
                ...
                <yg-blank :span="2"></yg-blank>
                <el-col :span="11">
                    <yg-input label="值含义" prop="username"
                              :value="ruleForm.username"
                              formLabelWidth="80px"
                              @ygForm="getData"></yg-input>
                </el-col>
            ...
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-input label="对应关键值" prop="username"
                              :value="ruleForm.username"
                              formLabelWidth="80px"
                              @ygForm="getData"></yg-input>
                </el-col>
                <yg-blank :span="2"></yg-blank>
                <el-col :span="11">
                    <yg-input label="关键值含义" prop="username"
                              :value="ruleForm.username"
                              formLabelWidth="80px"
                              @ygForm="getData"></yg-input>
                </el-col>
