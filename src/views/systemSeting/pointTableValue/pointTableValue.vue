<template>
    <div class="PointTableManagementBox">
        ...
        <el-dialog class="popupWindow" title="新增OPC配置" :visible.sync="isShowPopup.addOpc" width="725px">
            <AddOpc @isHide="isShowPopup.addOpc = false" @flushList="falush=new Date()"></AddOpc>
        </el-dialog>
...
<script>
    ...
    import inPuttemplate from "../../../components/common/inPuttemplate"
    import AddOpc from "./addOpc.vue"
        ...
        data(){
            return{
                ...
                tableData: {
                    ...
                    actionBtns: [
                        {
                            type: 'add', label:"<span style='color: #1881BF;font-size: 12px;text-decoration: underline'>删除</span>",
                            filter: {
                                field: 'id',
                                needel: [1,2,3,4,5]
                            }
