<template>
    <div>
        <el-form :model="ruleForm" :rules="rules" ref="ChangeTable">
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-input label="分项编号" prop="username"
                ...
                <el-col :span="11">
                    <yg-input label="分项名称" prop="username"
                              :value="ruleForm.username"
                              formLabelWidth="90px"
                              @ygForm="getData"></yg-input>
                </el-col>
            ...
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-select label="分类能耗类型" prop="pid"
                               formLabelWidth="90px"
                               :value="ruleForm.pid"
                               :options="options.pid"
                               @ygForm="getData"></yg-select>
                ...
                <yg-blank :span="2"></yg-blank>
                <el-col :span="11">
                    <yg-select label="分类能耗单位" prop="pid"
                               formLabelWidth="90px"
                               :value="ruleForm.pid"
                               :options="options.pid"
                               @ygForm="getData"></yg-select>
            ...
            <el-row :gutter="0">
                <div class="branchNamebox clear">
                    <label>分项表达式</label>
                    <textarea></textarea>
                    <span @click="showExpression">编辑</span>
                </div>
            </el-row>
            <el-row :gutter="0">
                <el-col :span="11">
            ...
            <el-row :gutter="0">
                <div style="padding-left: 90px" class="remarkBox clear">
                    <label style="top: 10px">描述信息</label>
                    <textarea></textarea>
                </div>
            </el-row>
            <el-row :gutter="0">
                <el-col :span="11">
                    <div class="defbox"><label>创建人</label>李三</div>
                </el-col>
                <yg-blank :span="2"></yg-blank>
                <el-col :span="11">
        ...
        <el-dialog class="popupWindow" title="分项表达式" :visible.sync="isShowPopup.expression" width="800px" :append-to-body="true">
            <Expression @isHide="isShowPopup.expression = false"></Expression>
        </el-dialog>
    </div>
</template>
