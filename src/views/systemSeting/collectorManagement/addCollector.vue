<template>
    <div>
        <el-form :model="ruleForm" :rules="rules" ref="ChangeTable">
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-select label="采集器编号" prop="type"
                               placeholder="请选择用户角色"
                               formLabelWidth="90px"
                               :value="ruleForm.type"
                ...
                <el-col :span="11">
                    <yg-select label="采集器名称" prop="type"
                               placeholder="请选择用户角色"
                               formLabelWidth="90px"
                               :value="ruleForm.type"
                               :options="options.type"
            ...
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-input label="所属项目" prop="username"
                ...
                <yg-blank :span="2"></yg-blank>
                <el-col :span="11">
                    <yg-input label="采集器IP地址" prop="username"
                              :value="ruleForm.username"
                              formLabelWidth="90px"
                              @ygForm="getData"></yg-input>
                </el-col>
            ...
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-input label="设备安装地址" prop="username"
                              :value="ruleForm.username"
                              formLabelWidth="90px"
                              @ygForm="getData"></yg-input>
                </el-col>
            ...
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-input label="采集使用时间" prop="username"
                              :value="ruleForm.username"
                              formLabelWidth="90px"
                              @ygForm="getData"></yg-input>
                </el-col>
                <yg-blank :span="2"></yg-blank>
                <el-col :span="11">
                    <yg-input label="上线时间" prop="username"
                              :value="ruleForm.username"
                              formLabelWidth="90px"
                              @ygForm="getData"></yg-input>
                </el-col>
            ...
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-radio-group  label="是否上线" prop="status"
            ...
            <el-row :gutter="0">
                <div style="position: relative" class="tablecr">
                    <el-button style="position: absolute;right: 0;top: 7;width: 20px;height: 30px;z-index: 999;font-size: 20px"
                        size="small"
                        @click="addTab(editableTabsValue2)"
                    >
                        <i class="el-icon-circle-plus-outline" style="position: relative;top:-4px;left: -10px"></i>
                    </el-button>
                    <el-tabs v-model="editableTabsValue2" type="card" closable @tab-remove="removeTab">
                        ...
                        >
                            <div class="branchNamebox clear">
                                <lable>支路名称</lable>
                                <textarea disabled :value="item.content"></textarea>
                                <span>编 辑</span>
                            </div>
                        </el-tab-pane>
                    </el-tabs>
