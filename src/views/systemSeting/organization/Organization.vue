<template>
    <div class="ComponentModelBox">
        <h3 class="ComponentModeltit">组织机构</h3>
        ...
        <el-dialog class="popupWindow" title="新增组织" :visible.sync="isShowPopup.addComponent" width="720px">
            <AddOrganization @isHide="isShowPopup.addComponent = false" @flushList="falush=new Date()"></AddOrganization>
        </el-dialog>
        <el-dialog class="popupWindow" title="导入组织" :visible.sync="isShowPopup.inPuttemplate" width="656px">
...
<script>
    ...
    export default {
        ...
        data(){
            return{
                ImportUrl:{
                    downloadURL:this.$url.OrganizationExportTemp,
                    uploadingURL:this.$url.OrganizationImportTemp
                },
                isShowPopup: {
                    addComponent: false,
                    inPuttemplate: false,
                ...
                ajax: {
                    url: '/api/admin/subentry/getList?token=test',
                    method:"post",
                    data: {
                        pageNum: 1,
                        pageSize: 15
