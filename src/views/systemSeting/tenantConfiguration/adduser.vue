    ...
    <div>
        <el-form :model="ruleForm" :rules="rules" ref="ChangeTable">
            <el-row :gutter="0">
                ...
                <el-col :span="11">
                    <yg-input label="租户编号" prop="username"
            ...
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-input label="租户名称" prop="username"
                              :value="ruleForm.username"
                              formLabelWidth="80px"
                              @ygForm="getData"></yg-input>
                </el-col>
                <yg-blank :span="2"></yg-blank>
                <el-col :span="11">
                    <yg-input label="手机号" prop="username"
                              :value="ruleForm.username"
                              formLabelWidth="80px"
                              @ygForm="getData"></yg-input>
                </el-col>
            ...
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-input label="位置区域" prop="username"
                              :value="ruleForm.username"
                              formLabelWidth="80px"
                              @ygForm="getData"></yg-input>
                </el-col>
                <yg-blank :span="2"></yg-blank>
                <el-col :span="11">
                    <yg-select label="租户类型" prop="type"
                               placeholder="请选择用户角色"
                               formLabelWidth="80px"
                               :value="ruleForm.type"
                               :options="options.type"
            ...
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-input label="面积" prop="username"
                              :value="ruleForm.username"
                              formLabelWidth="80px"
                              @ygForm="getData"></yg-input>
                </el-col>
                <yg-blank :span="2"></yg-blank>
                <el-col :span="11">
                    <yg-select label="付费类型" prop="type"
                               placeholder="请选择用户角色"
                               formLabelWidth="80px"
                               :value="ruleForm.type"
                               :options="options.type"
            ...
            <el-row :gutter="0">
               <div class="branchNamebox clear">
                   ...
                   <span @click="showExpression">编 辑</span>
        ...
        <el-dialog class="popupWindow" title="支路名称" :visible.sync="isShowPopup.SelectBranchName" width="748px" :append-to-body="true">
...
<script>
    ...
    import selectBranchName from "./selectBranchName"
