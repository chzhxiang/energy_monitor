<template>
    <div>
        <el-form :model="ruleForm" :rules="rules" ref="ChangeTable">
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-input label="区域编号" prop="username"
                ...
                <el-col :span="11">
                    <yg-input label="区域名称" prop="username"
                              :value="ruleForm.username"
                              formLabelWidth="90px"
                              @ygForm="getData"></yg-input>
                </el-col>
        ...
        <el-dialog class="popupWindow" title="区域表达式" :visible.sync="isShowPopup.expression" width="800px" :append-to-body="true">
