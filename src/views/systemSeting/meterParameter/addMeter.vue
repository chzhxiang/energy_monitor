<template>
    <div>
        <el-form :model="ruleForm" :rules="rules" ref="ChangeTable">
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-input label="参数编号" prop="username"
                ...
                <el-col :span="11">
                    <yg-select label="参数名称" prop="type"
                               placeholder="请选择用户角色"
                               :value="ruleForm.type"
                               formLabelWidth="110px"
            ...
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-select label="设备类型" prop="type"
                               placeholder="请选择用户角色"
                               :value="ruleForm.type"
                               formLabelWidth="110px"
                               :options="options.type"
            ...
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-select label="数据计算方式" prop="type"
                               placeholder="请选择用户角色"
                               :value="ruleForm.type"
                               formLabelWidth="110px"
                               :options="options.type"
                ...
                <yg-blank :span="2"></yg-blank>
                <el-col :span="11">
                    <yg-select label="小数点位数" prop="type"
                               placeholder="请选择用户角色"
                               :value="ruleForm.type"
                               formLabelWidth="110px"
                               :options="options.type"
            ...
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-input label="命令一" prop="username"
                              :value="ruleForm.username"
                              formLabelWidth="110px"
                              @ygForm="getData"></yg-input>
                </el-col>
                <yg-blank :span="2"></yg-blank>
                <el-col :span="11">
                    <yg-input label="命令二" prop="username"
                              :value="ruleForm.username"
                              formLabelWidth="110px"
                              @ygForm="getData"></yg-input>
                </el-col>
            ...
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-input label="命令三" prop="username"
                              :value="ruleForm.username"
                              formLabelWidth="110px"
                              @ygForm="getData"></yg-input>
                </el-col>
                <yg-blank :span="2"></yg-blank>
                <el-col :span="11">
                    <yg-input label="表计点合并数据" prop="username"
                              formLabelWidth="110px"
                              :value="ruleForm.username"
                              @ygForm="getData"></yg-input>
                </el-col>
            ...
            <el-row :gutter="0">
                ...
                <yg-blank :span="2"></yg-blank>
                <el-col :span="11">
                    <yg-radio-group  label="采集读数命令" prop="status"
                                     :value="ruleForm.status"
                                     formLabelWidth="110px"
                                     :options="options.status"
                                     @ygForm="getData"></yg-radio-group>
