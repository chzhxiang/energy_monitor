<template>
    <div>
        <el-form :model="ruleForm" :rules="rules" ref="ChangeTable">
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-input label="事件名称" prop="username"
                ...
                <el-col :span="11">
                    <yg-select label="事件类型" prop="type"
                               placeholder="请选择用户角色"
                               :value="ruleForm.type"
                               formLabelWidth="110px"
            ...
            <el-row :gutter="0">
                <el-col :span="11">
                    <div class="typingInput mb20">
                        <span style="display:inline-block;width: 105px">开始时间</span>
                        <el-date-picker
                            style="width:198px"
                ...
                <el-col :span="11">
                    <div class="typingInput mb20">
                        <span style="display:inline-block;width: 105px" >结束时间</span>
                        <el-date-picker
                            style="width:198px"
            ...
            <el-row :gutter="0">
                <el-col :span="11">
                    <yg-select label="影响能耗类型" prop="type"
                               placeholder="请选择用户角色"
                               :value="ruleForm.type"
                               formLabelWidth="110px"
                               :options="options.type"
                ...
                <yg-blank :span="2"></yg-blank>
                <el-col :span="11">
                    <yg-select label="严重程度" prop="type"
                               placeholder="请选择用户角色"
                               :value="ruleForm.type"
                               formLabelWidth="110px"
                               :options="options.type"
            ...
            <el-row :gutter="0">
                <div style="padding-left: 110px" class="remarkBox clear">
                    <label>事件描述</label>
            ...
            <el-row :gutter="0">
                <el-col :span="11">
                    <div class="defbox"><label>添加人</label>李三</div>
                </el-col>
                <yg-blank :span="2"></yg-blank>
                <el-col :span="11">
                    <div class="defbox"><label>添加时间</label>2017</div>
                </el-col>
            </el-row>
            <el-row :gutter="0">
            </el-row>
